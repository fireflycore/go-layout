...
- 未经许可不要重命名变量/函数/类型/包
- 遵循项目的命名风格并与代码库保持一致
- 匹配 Go 约定与项目既有风格（导出标识符 PascalCase、非导出 lowerCamelCase、包名小写、文件名小写）
- 对历史原因造成的风格差异（例如 `UserId` vs `UserID`）以项目现状为准，避免混用
...
# ============================================
# 在 AI 对话中引用此文件：
#   "@.trae/rules/core/requirements-spec.md 实现订单模块"
#
# ============================================
# 项目类型配置
# ============================================
